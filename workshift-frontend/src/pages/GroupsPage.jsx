    ...
    <div className="w-full space-y-8">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
        <div className="p-6 bg-surface-container-lowest rounded-xl shadow-[0_24px_48px_rgba(0,52,94,0.06)] border border-outline/5">
          ...
          <div className="text-xs text-primary font-medium mt-1">Manager role</div>
        </div>
        <div className="p-6 bg-surface-container-lowest rounded-xl shadow-[0_24px_48px_rgba(0,52,94,0.06)] border border-outline/5">
          ...
          <div className="text-xs text-tertiary font-medium mt-1">Staff role</div>
        </div>
        <div className="p-6 bg-surface-container-lowest rounded-xl shadow-[0_24px_48px_rgba(0,52,94,0.06)] border border-outline/5">
          ...
          <div className="text-xs text-amber-600 font-medium mt-1">Pending approval</div>
        </div>
      </div>
      ...
      {totalActive > 0 && (
        <div>
          <h3 className="text-xs font-bold tracking-widest text-on-surface-variant uppercase mb-4">Groups đang hoạt động ({totalActive})</h3>
              ...
              >
                <div className="flex items-start justify-between">
                  ...
                  <span className={`text-[10px] font-bold uppercase tracking-wider px-3 py-1 rounded-full flex-shrink-0 ${
                    ...
                    {g.myRole === 'MANAGER' ? 'Manager' : 'Staff'}
                  </span>
                </div>
      ...
      {groups.length === 0 && (
        <div className="text-center py-16 bg-surface-container-lowest rounded-2xl border border-outline/10 border-dashed">
          ...
          <p className="text-on-surface-variant font-medium">Sử dụng nút "Tạo Group" hoặc "Join Group" ở sidebar bên trái để bắt đầu.</p>
        </div>
      )}
    </div>
  )
